...
public class Datetimepicker {
	public static void main(String[] args) {
		...
		month.click();
		WebElement date=driver.findElement(By.xpath("//span[@aria-label='November 12, 2025']"));
		//WebElement date=driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/div[1]/div[1]/span[2]"));
		date.click();
		WebElement inputfield=driver.findElement(By.id("datetimepicker1"));
		String selectedDate = inputfield.getAttribute("value"); // Get the value of the clicked date
